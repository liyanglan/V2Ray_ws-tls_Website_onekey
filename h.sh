...
v2ray_hello(){
	echo ""
	echo -e "${Info} ${GreenBG} 你正在执行 V2RAY 基于 NGINX 的 VMESS+WS+TLS+Website(Use Host) 一键安装脚本 ${Font}"
	echo ""
	random_number
}
...
web_install(){
	...
	sleep 2
	mkdir /www
	wget https://github.com/liyanglan/ws-tls_Website/raw/master/V2rayWebsite.tar.gz
